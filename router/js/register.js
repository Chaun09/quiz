    ...
    $scope.register = function () {
        ...
        dbRef.on('value', (snapshot) => {
            ...
            if (!checkTonTai) {
                ...
                Email.send({
                    ...
                    From: "loan.contact@gmail.com",
                    Subject: "Hệ thống trắc nghiệm gửi mã xác nhận tài khoản",
        ...
        async function confirmExamCode() {
            ...
            Email.send({
                ...
                To: $scope.Student.email,
                From: "loan.contact@gmail.com",
                Subject: "Hệ thống trắc nghiệm online gửi mã xác nhận tài khoản",
                Body: "Xin chào " + $scope.Student.username + " mã xác nhận của bạn là: " + confirmCode
            }).then(
                message => alert(message)
            );
            ...
            if (text) {
                ...
                if (text == confirmCode) {
                    ...
                    Swal.fire({
                        title: '<h1 style="color: red; font-size:20px;font-weight: bold;">Mã xác nhận không đúng! <br>Vui lòng thử lại!</h1>',
                        icon: 'warning',
                        showConfirmButton: false,
                        showCancelButton: false,
                        timer: 3000
